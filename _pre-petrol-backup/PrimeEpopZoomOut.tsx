...
export const HOLD1_SECONDS = 1.0;
export const ZOOM_SECONDS = 2.0;
...
export const PrimeEpopZoomOut: React.FC = () => {
  ...
  const idxs = [findIdx(DATA, "1999-01-01"), findIdx(DATA, "2019-12-01"), findIdx(DATA, "2023-05-01"), n - 1];
  ...
  const waypoints = makeWaypoints(DATA, idxs, { max: cbMax, pad: cbPad });
